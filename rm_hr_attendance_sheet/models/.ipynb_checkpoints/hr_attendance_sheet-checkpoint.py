...
class AttendanceSheet(models.Model):
    ...
    def _get_workday_lines(self):
        ...
        # print(">>>>>>>>>>>>>>>>>>>>>>>>>>",self.tot_overtime/self.contract_id.resource_calendar_id.hours_per_day)
        overtime = [{
            'name': "Overtime",
            'code': 'OVT',
            'work_entry_type_id': overtime_work_entry[0].id,
            'sequence': 30,
            'number_of_days': self.tot_overtime/self.contract_id.resource_calendar_id.hours_per_day  if self.contract_id.resource_calendar_id.hours_per_day>0 else 0,
        ...
        absence = [{
            ...
            'sequence': 35,
            'number_of_days': self.tot_absence/self.contract_id.resource_calendar_id.hours_per_day  if self.contract_id.resource_calendar_id.hours_per_day>0 else 0,
        ...
        late = [{
            ...
            'sequence': 40,
            'number_of_days': self.tot_late/self.contract_id.resource_calendar_id.hours_per_day  if self.contract_id.resource_calendar_id.hours_per_day>0 else 0,
        ...
        difftime = [{
            ...
            'sequence': 45,
            'number_of_days': self.tot_difftime/self.contract_id.resource_calendar_id.hours_per_day  if self.contract_id.resource_calendar_id.hours_per_day>0 else 0,
